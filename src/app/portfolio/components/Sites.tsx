  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-4 text-xl text-gray-500 dark:text-gray-400 max-w-3xl">Explore a collection of websites I've designed and developed, showcasing my skills in web development and design.</p>
        </div>
